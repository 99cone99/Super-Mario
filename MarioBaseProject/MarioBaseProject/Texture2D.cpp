...
bool Texture2D::LoadFromFile(std::string path)
{
	...
	if (p_surface != nullptr)
	{
		...
		//Create a texture from the pixels on the surface
...
void Texture2D::Render(SDL_Rect src_rect, SDL_Rect scr_dest, SDL_RendererFlip flip, double angle)
{
	SDL_RenderCopyEx(m_renderer, m_texture, &src_rect, &scr_dest, angle, nullptr, flip);
}
